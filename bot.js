...
client.on("message", async message => {
  ...
  if(command === "verify_566273291363287051") {
    ...
    // Then we delete the command message (sneaky, right?). The catch just ignores the error with a cute smiley thing.
    // And we get the bot to say the thing: 
    message.channel.send("(1) result found for query " + "`566273291363287051` <:snowflakeID:717854309081022528>");
  }
  ...
  if(command === "verify_566273291363287001") {
    ...
    // Then we delete the command message (sneaky, right?). The catch just ignores the error with a cute smiley thing.
    // And we get the bot to say the thing: 
    message.channel.send("Error: (0) results found for query " + "`566273291363287001`.");
  }
